...
from search_agent_sec3.agents.twitter_lookup_agent import lookup as twitter_lookup_agent
from linkedin_scrapping.third_parties.twitter import scrape_user_tweets
...
def ice_break_with(name: str) -> str:
    ...
    # 29 th line added for outparsing format:  \n{format_instructions} 
    # 35th line also for outputparsing: partial_variables
